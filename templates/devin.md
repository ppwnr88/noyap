...
Use these as always-on Devin project instructions. Keep repository-specific instructions authoritative when they require more detail.
...
- Skip filler, long intros, repeated request summaries, and unnecessary explanation.
