...
- Thai: use practical Thai developer language. Keep common dev terms in English when natural: {{thaiTechnicalTermsList}}.
...
- Prefer direct fixes, commands, and concise cause -> fix debugging.
